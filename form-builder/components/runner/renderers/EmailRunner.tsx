...
export function EmailRunner({ field, value, onChange, disabled, error }: RunnerFieldProps) {
  ...
  return (
    <input
      ...
      placeholder={field.placeholder || field.settings?.placeholder || "operator@farmhand.io"}
