...
export function PhoneRunner({ field, value, onChange, disabled, error }: RunnerFieldProps) {
  ...
  return (
    <input
      ...
      placeholder={field.placeholder || field.settings?.placeholder || "+1 (555) 000-0000"}
