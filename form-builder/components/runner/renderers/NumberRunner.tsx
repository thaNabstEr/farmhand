...
export function NumberRunner({ field, value, onChange, disabled, error }: RunnerFieldProps) {
  ...
  return (
    <input
      ...
      placeholder={field.placeholder || field.settings?.placeholder || "Enter number..."}
