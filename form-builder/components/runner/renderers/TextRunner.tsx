...
export function TextRunner({ field, value, onChange, disabled, error }: RunnerFieldProps) {
  ...
  return (
    <input
      ...
      placeholder={field.placeholder || field.settings?.placeholder || "Enter short answer..."}
